...
SCANNER_DEEP_SCORE_LIMIT = int(os.getenv("SCANNER_DEEP_SCORE_LIMIT", "300"))
SCANNER_PROGRESS_EVERY = int(os.getenv("SCANNER_PROGRESS_EVERY", "250"))
SCANNER_MAX_SCAN_SECONDS = int(os.getenv("SCANNER_MAX_SCAN_SECONDS", "300"))
...
MAX_POSITION_EQUITY_PERCENT = float(os.getenv("MAX_POSITION_EQUITY_PERCENT", "10"))
